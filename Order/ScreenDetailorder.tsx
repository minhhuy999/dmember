...
const ScreenDetailorder = ({ navigation }: any) => {
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.box1}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={styles.Text1}>002220321D9M</Text>
                    </View>
                ...
                <View style={styles.box1}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <Text style={styles.Text4}>5,580,000</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ color: color.organge, fontSize: 15, fontWeight: '600' }}>1,652,000</Text>
                    </View>
                </View>
                ...
                <View style={styles.boxlocation}>
                    ...
                    <View style={{ paddingRight: 30, marginLeft: 10 }}>
                        <View style={{ flexDirection: 'row' }}>
                            <Text style={styles.Text3}>Thùy Linh</Text>
                            <View style={{ backgroundColor: 'black', height: 20, width: 1, marginHorizontal: 10 }}></View>
                            <Text style={styles.Text3}>0909078111</Text>
                        </View>
